...
class pose2image(object):
    def __init__(self, sess, image_size=128,
                 ...
                 content_weight=0.01, style_weight=1e-12,
    ...
    def build_model(self):
        ...
        # style loss
        style_pre = vgg.preprocess(self.style)
        net_style = vgg.net(self.vgg_path, style_pre)

        fake_target_pre = vgg.preprocess(self.fake_target)
        ...
        target_pre = vgg.preprocess(self.target)
    ...
    def train(self, args):
        ...
        for epoch in xrange(args.epoch):
            ...
            if np.mod(epoch, 10) == 0:
                TEST_DIR = args.test_dir + '/epoch_' + str(epoch)
    ...
    def generator(self, pose, style, y=None):
        with tf.variable_scope("generator") as scope:
            ...
            e7 = self.g_bn_e7(conv2d(lrelu(e6), 10, name='g_e7_conv'))
            # e7 is (2 x 2 x 10)
